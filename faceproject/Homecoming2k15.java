...
public class Homecoming2k15
{
    public static void getADATE()  {
        ...
        System.out.println();
        System.out.println(Great! It'll be a magical night  and  going to Mills Homecoming Dance 2015!");
    ...
    public static int statsTable(int tickets)
